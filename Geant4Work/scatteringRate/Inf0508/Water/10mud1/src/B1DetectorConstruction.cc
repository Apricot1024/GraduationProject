...
{  
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 13*m, env_sizeZ = 13*m;
  ...
  // //     
  // // Shape 1 Pb_shielding 球形屏蔽层
  // //  
  // G4Material* shape1_mat = nist->FindOrBuildMaterial("G4_Pb");
  // G4ThreeVector pos1 = G4ThreeVector();
  // // Sphere shape
  // G4double shape1pRmin = 0;
  // G4double shape1pRmax = mudh;
  // G4double shape1pSPhi = 0.0*degree;
  // G4double shape1pDPhi = 360.0*degree;
  // G4double shape1pSTheta = 0.0*degree;
  // G4double shape1pDTheta = 180.0*degree;
  // G4Sphere* solidShape1 =    
  //   new G4Sphere("Shape1",
  //     shape1pRmin,     //its name
  //     shape1pRmax,
  //     shape1pSPhi,
  //     shape1pDPhi,
  //     shape1pSTheta,
  //     shape1pDTheta ); //its size
  ...
  //     
  // Shape 2  Galactic Sphere to count particles
  //
  ...
  // Sphere shape
  G4double pRmin = mudh;
  G4double pRmax = mudh + 1*mm;
  G4double pSPhi = 0.0*degree;
  G4double pDPhi = 360.0*degree;
  G4double pSTheta = 0.0*degree;
  G4double pDTheta = 180.0*degree;
