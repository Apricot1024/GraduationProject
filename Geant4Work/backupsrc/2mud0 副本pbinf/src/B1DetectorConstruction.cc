...
{  
  ...
  // Conical section shape
  // G4double shape1_sizeXY = 20*cm;
  // G4double shape1_sizeZ  = 2*cm;
  G4double shape1_sizeXY = env_sizeXY;
  // G4double shape1_sizeZ  = 0.5 * (env_sizeZ + mudh - shape2_pDz);
  G4double shape1_sizeZ  = env_sizeZ;

  // G4ThreeVector pos1 = G4ThreeVector(0,0,-0.5 * (env_sizeZ - shape1_sizeZ));
